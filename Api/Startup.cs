    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
                    ...
                    var claims = new List<Claim>()
        {
            ...
            endpoint.MapGet("/administradores", ([FromQuery] int? pagina, IAdministradorServico administradorServico) =>
            {
                ...
                var admisnistradores = administradorServico.Todos(pagina);
                foreach (var adm in admisnistradores)
                {
            ...
            //rota restrita
            endpoint.MapGet("/Administradores/{id}", ([FromRoute] int id, IAdministradorServico admnistradorServico) =>
            {
                var administrador = admnistradorServico.BuscaPorId(id);
            ...
            ErrosdeValidacao validaDTO(VeiculoDTO veiculoDTO)
            {
                ...
                if (veiculoDTO.Ano < 1950)
                    validacao.Mensagens.Add("Ano inválido, aceito apenas superiores à 1950");
